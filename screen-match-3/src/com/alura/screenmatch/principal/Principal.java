...
public class Principal {
    public static void main(String[] args) {
        ...
        var peliculaDeBruno = new Pelicula("El señor de los anillos", 2001);     //  var es lo mismo que colocar Pelicula

        peliculaDeBruno.setDuracionEnMinutos(180);



        ArrayList<Pelicula> listaDePeliculas = new ArrayList<>();   ///   el simbolo de <  >  significa que debemos de colocar el tipo de datos que debe de contener el arrayList
        ...
        //  sintaxix de como definir un array
